...
execute as @a[scores={goto_waypoint=1..}] run function fisch37:waypoints/teleport_to_waypoint/init_absolute
...
execute as @a[scores={goto_waypoint_rel=1..}] if predicate fisch37:waypoints/holds_rel_book run function fisch37:waypoints/teleport_to_waypoint/init_relative

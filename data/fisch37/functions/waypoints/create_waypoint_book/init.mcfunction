...
data merge storage fisch37:waypoints {current_waypoint:{name:"",author:"",description:"\"No description provided\"",Pos:[0,0,0],cost:0,dimension:{index:0,name:"Overworld"}}}

...
execute if score target_waypoint f37_waypoints_RAM matches 0 run data modify storage fisch37:waypoints target_waypoint set from storage fisch37:waypoints iter_waypoints[0]
# Loop iteration action
data remove storage fisch37:waypoints iter_waypoints[0]
